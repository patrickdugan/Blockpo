...
./omnicore-cli -datadir=/home/lihki/.bitcoin --regtest  sendtoaddress $ADDRBase 40  # enviamos 10 BTC a ADDR[i]
printf "\n________________________________\n"
...
do
	...
	JSON="{\"moneyqMan7uh8FqdCA2BV5yZ8qVrc9ikLP\":40,\""$ADDRBase"\":0.1,\""${ADDR[$i]}"\":0.1}"
	...
	printf "\n________________________________\n"
	printf " Creating Future Contract #$i:\n"
	TRA=$(./omnicore-cli -datadir=/home/lihki/.bitcoin --regtest omni_createcontract ${ADDR[1]} 2 3 1 "Derivaties" "Futures Contracts" "Future Contract 1" "www.tradelayer.org" "Futures Contracts Exchange on OmniLayer" 3 "1" 120 30 2 200 100 1 2)
	./omnicore-cli -datadir=/home/lihki/.bitcoin --regtest generate 1 ## Generating one block
	printf "\n________________________________\n"
